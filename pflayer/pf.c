...
int PF_logical_reads = 0;
int PF_logical_writes = 0;
int PF_physical_reads = 0;
int PF_physical_writes = 0;

void PF_ResetStats() {
	PF_logical_reads = 0;
	PF_logical_writes = 0;
	PF_physical_reads = 0;
	PF_physical_writes = 0;
}
...
int strategy;		/* buffer replacement strategy */
/****************************************************************************
SPECIFICATIONS:
